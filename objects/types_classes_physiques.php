<?php
class Type_Classes_Physiques{

    // database connection and table name
    private $conn;
    private $table_name = "ephy_type_classe_physique";

    // object properties
    public $id_type_classe_physique;
    public $libelle_type_classe_physique;
    public $etat_type_classe_physique;
...
function readOne(){
    ...
    $query = "SELECT * FROM " . $this->table_name . "  WHERE  id_type_classe_physique = ?";
    ...
    $this->libelle_type_classe_physique = $row['libelle_type_classe_physique'];
    $this->etat_type_classe_physique = $row['etat_type_classe_physique'];
}

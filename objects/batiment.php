...
function update(){
    ...
    function getlibelle(){
        ...
        $query = "SELECT * FROM " . $this->table_name . "  WHERE  libelle_batiments = '".$this->libelle_batiments."' AND code_str = '".$this->code_str."'";
...
function readEtab(){
    ...
    // select all query
    $query = "SELECT id_batiments, id_type_batiments, code_batiments,code_str, libelle_batiments, COALESCE(lat_batiments,'') lat_batiments, COALESCE(long_batiments,'') long_batiments, etat_batiments FROM " . $this->table_name . " WHERE code_str = ?";

...
// set batiment property values
    ...
    if($options->postOption()){

        $data = array('code' => '0',
            'message' => 'Options programmes bien inserer');
...
// if unable to create the batiment, tell the user
        ...
        $data = array('code' => '1',
            'message' => 'Impossible dinserer les options');
        echo json_encode($data);
    }
}
